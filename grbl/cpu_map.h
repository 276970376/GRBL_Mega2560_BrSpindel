...
// BlueOrangeLive - ESC-Brushless-Motor-Spindle
// PWM Anpassung

#ifdef CPU_MAP_ESC_BRSPINDLE
  // Serial port interrupt vectors
  #define SERIAL_RX USART0_RX_vect
  #define SERIAL_UDRE USART0_UDRE_vect
  ...
  // Advanced Configuration Below You should not need to touch these variables
  // Set Timer up to use TIMER4B which is attached to Digital Pin 7
  #define SPINDLE_PWM_MAX_VALUE     1024.0 // BlueOrangeLive 1024.0 = 0x400 //Translates to about 1.9 kHz PWM frequency at 1/8 prescaler
  #define SPINDLE_TCCRA_REGISTER		TCCR4A
  #define SPINDLE_TCCRB_REGISTER		TCCR4B
  #define SPINDLE_OCR_REGISTER	  	OCR4B
  #define SPINDLE_COMB_BIT			    COM4B1
  ...
  #define SPINDLE_TCCRB_INIT_MASK ((1<<WGM42) | (1<<WGM43) | (1<<CS41))
  #define SPINDLE_OCRA_REGISTER   OCR4A // 16-bit Fast PWM mode requires top reset value stored here.
  #define SPINDLE_OCRA_TOP_VALUE  0x9C40 // BlueOrangeLive 0x9C40 = 50Hz 0x400 = 1,9kHz PWM counter reset value. Should be the same as PWM_MAX_VALUE in hex.
