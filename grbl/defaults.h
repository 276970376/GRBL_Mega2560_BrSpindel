...
// Test ESC - BRUSHLESS_SPINDEL  bei ca. 50Hz PWM
  #define BRUSHLESS_SPINDEL 1     //  ESC - BRUSHLESS_SPINDEL
  #define OUT_BRSP_Steht   1800   // PWM ca. 0,9 ms high
  #define OUT_BRSP_START   2700   // PWM ca. 1,3 ms high
  #define OUT_BRSP_END     3300   // PWM ca. 2 ms high
  #define IN_BRSP_START    6000   // Startdrehzahl U/min
  #define IN_BRSP_END      24000  // Enddrehzahl wenn ereichbar vom Motor
#endif
// End BlueOrangeLive
