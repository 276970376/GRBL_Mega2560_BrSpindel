...
#define DEFAULTS_ESC_BRSPINDEL   // BlueOrangeLive -  Test with ESC-Brushless-Spindle-Motor

// #define CPU_MAP_2560_INITIAL

#define CPU_MAP_ESC_BRSPINDLE    // BlueOrangeLive -  Test with ESC-Brushless-Spindle-Motor
